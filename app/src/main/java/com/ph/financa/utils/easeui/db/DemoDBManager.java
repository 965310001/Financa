package com.ph.financa.utils.easeui.db;
...
import com.ph.financa.utils.easeui.Constant;
...
public class DemoDBManager {
    ...
    private DemoDBManager() {
        dbHelper = DbOpenHelper.getInstance(Utils.getContext());
    }
    ...
    synchronized public List<InviteMessage> getMessagesList() {
        ...
        if (db.isOpen()) {
            Cursor cursor = db.rawQuery(String.format("select * from  %s desc", InviteMessgeDao.TABLE_NAME), null);
            while (cursor.moveToNext()) {
